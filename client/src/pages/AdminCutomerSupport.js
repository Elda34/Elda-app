        ...
        <table className="w-full text-left table-auto">
          <thead>
            ...
            <th className="px-4 py-2 border border-gray-700">Name</th>
              ...
              <th className="px-4 py-2 border border-gray-700">Pincode</th>
            ...
            {messages.length > 0 ? (
              messages.map((message) => (
                <tr key={message._id}>
                  ...
                  <td className="px-4 py-2 border border-gray-700">{message.phone}</td>
                  <td className="px-4 py-2 border border-gray-700">{message.message}</td>
                  <td className="px-4 py-2 border border-gray-700">{message.address}</td>
                  <td className="px-4 py-2 border border-gray-700">{message.pincode}</td>
