  ...
  return (
    <div className="bg-white p-6 md:p-12 lg:p-16 max-w-7xl mx-auto text-gray-800">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          <strong>eldaappliances.com</strong>, a unit of LaMart Group, is committed to making your shopping experience with us as seamless and delightful as possible. We assure you that all products we sell are brand new and 100% genuine.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          We reserve the right to cancel your bulk orders placed on the website. To avoid such cancellations and/or for bulk orders, please contact us at <a href="mailto:support@eldaelectronics.com" className="text-blue-600 hover:underline">support@eldaelectronics.com</a> or call us at +91 9884890934.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          In case your product is damaged, you can request a replacement, which must be reported to us within 24 hours of delivery. If the product you received is damaged, defective, or not as described, you must mail us with the reason, and once the mail is received, the return process will be initiated.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Return is applicable only if there are any manufacturing defects, based on company approvals, and must be reported to us within 24 hours of delivery. Once approved, the return process will take 2 working days, and the payment will be refunded within 7 working days.
        </p>
        <p className="mb-4">
          Users can send a Return request to our customer support team at <a href="mailto:support@eldaelectronics.com" className="text-blue-600 hover:underline">support@eldaelectronics.com</a> from your registered email ID with the reason for Product Return.
        </p>
      </section>
