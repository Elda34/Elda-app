  ...
  return (
    <div className="bg-white p-6 md:p-12 lg:p-16 max-w-4xl mx-auto">
      ...
      <p className="mb-4">
        ...
        eldaappliances.com, a unit of LaMart Group.
      </p>

      <h2 className="text-xl font-semibold mb-2">Shipping/Delivery Area</h2>
      <p className="mb-4">
        Currently, delivery of products purchased on eldaappliances.com, a unit of LaMart Group, is
      ...
      <p className="mb-4">
        All Products sold by eldaappliances.com are delivered free across Tamilnadu.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        eldaappliances.com reserves the right to cancel the order at its discretion.
      </p>
