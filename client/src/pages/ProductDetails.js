            ...
            (
              <div className='flex flex-col gap-1'>
                ...
                <div className='flex items-center gap-3 my-2'>
                  {data?.isHidden ? (<button className='text-sm bg-red-600 hover:bg-red-700 text-white px-3 py-0.5 rounded-full' onClick={handleEnquiry} >Enquiry Now</button>) : (<><button className='border-2 border-red-600 rounded px-3 py-1 min-w-[120px] text-red-600 font-medium hover:bg-red-600 hover:text-white' onClick={(e)=>handleBuyProduct(e,data?._id)}>Buy</button>
